...
import { Code2, Palette, Database, Smartphone, Cloud, GitBranch, Layers, Terminal, Cpu, Zap, Box, Sparkles } from 'lucide-react';
  ...
  return <section ref={sectionRef} className="py-24 px-6">
      <div className="container mx-auto max-w-7xl">
        ...
        <div className="text-center mb-16">
          <h2 className="text-5xl md:text-6xl font-bold mb-6 bg-gradient-to-r from-primary via-accent to-primary bg-clip-text text-transparent">Skills </h2>
        ...
        <div ref={cardsRef} className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mb-20">
          ...
          return <div key={index} className="skill-card glass-card rounded-2xl p-8 group hover:scale-[1.02] transition-all duration-300">
                {/* Icon Header */}
                ...
                <div className="space-y-2">
                  {category.skills.map((skill, skillIndex) => <div key={skillIndex} className="flex items-center gap-2 text-muted-foreground group-hover:text-foreground transition-colors">
                ...
                <div className="mt-6 h-1 bg-muted rounded-full overflow-hidden">
                  <div className={`h-full bg-gradient-to-r ${category.color} transform origin-left group-hover:scale-x-100 scale-x-75 transition-transform duration-500`} />
                </div>
              </div>;
        })}
        </div>
        ...
        <div className="glass-card rounded-3xl p-12">
          ...
          <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-6">
            ...
            return <div key={index} className="tech-icon flex flex-col items-center gap-3 p-4 rounded-xl hover:bg-muted/50 transition-all duration-300 group cursor-pointer">
